        ...
        {inspections.length > 0 ? (
          <Card className="border-green-300">
            <CardHeader className="bg-green-50">
              <CardTitle className="text-green-700">Activated Warehouse Inspections</CardTitle>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Activated Inspections</h3>
